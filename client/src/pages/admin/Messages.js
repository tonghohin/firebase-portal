  ...
  return (
    <motion.main className="bg-main-bg bg-cover overflow-auto" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
      <div className="backdrop-blur-sm backdrop-contrast-50 h-full w-full p-5 overflow-auto">
        <h1 className="text-4xl text-gray-100 font-semibold mb-4">Messages</h1>
        <section className="p-2 text-md bg-white border-2 border-green-700 rounded mb-4">
          <h1 className="text-gray-800 font-bold col-span-full">New Message</h1>
        ...
        <section className="p-2 text-md bg-white mt-2 border-2 border-gray-500 rounded">
          <h1 className="text-gray-800 font-bold col-span-full">Past Message</h1>
